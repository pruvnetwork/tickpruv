        ...
        <aside className="sidebar" id="sidebar">
          ...
          <div className="sidebar-footer">
            ...
            <div className="sidebar-footer-links">
              <a href="https://github.com/pruvnetwork/tickpruv" target="_blank" rel="noopener" className="sidebar-footer-link"><GithubIcon />GitHub</a>
        ...
        <main className="docs-main">
          <div className="docs-content">
            ...
            <p className="paper-source" style={{marginTop:'6px'}}>
              <a href="https://github.com/pruvnetwork/tickpruv" target="_blank" rel="noopener">Source repository ↗</a>.
